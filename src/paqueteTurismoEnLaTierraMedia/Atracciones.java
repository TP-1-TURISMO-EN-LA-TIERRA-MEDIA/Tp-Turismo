			...
			try {
				...
				for (int i = 0; i < 10; i++) {
					try {
						...
						linea = br.readLine();
						System.out.println(atracciones[i].nombre + " costo: " +
								atracciones[i].costo + " Tiempo : " + atracciones[i].tiempo + 
								" cupo: " + atracciones[i].cupo + " Tipo de Atraccion: " + atracciones[i].tipo);
					} catch (Exception x) {
